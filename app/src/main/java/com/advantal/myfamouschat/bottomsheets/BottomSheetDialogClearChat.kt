...
import com.advantal.myfamouschat.databinding.BottomSheetClearChatBinding
//import com.advantal.myfamous.R
//import com.advantal.myfamous.databinding.BottomSheetClearChatBinding
import com.google.android.material.bottomsheet.BottomSheetBehavior
import com.google.android.material.bottomsheet.BottomSheetDialog
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

/**
 * Bottom sheet dialog clear chat
 *
 * @constructor Create empty Bottom sheet dialog clear chat
 */
class BottomSheetDialogClearChat: BottomSheetDialogFragment() {
    private var onCompleteListener: OnCompleteListener? = null
    private var mgr: InputMethodManager? = null
    private var _binding: BottomSheetClearChatBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
        ...
        _binding = BottomSheetClearChatBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnClearChat.setOnClickListener {
            dismiss()
            onCompleteListener!!.OnOptionTap(0)
        }
