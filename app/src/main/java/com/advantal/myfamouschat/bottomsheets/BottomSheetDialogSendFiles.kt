...
import com.advantal.myfamouschat.databinding.BottomSheetSendFilesBinding
import com.google.android.material.bottomsheet.BottomSheetBehavior
import com.google.android.material.bottomsheet.BottomSheetDialog
import com.google.android.material.bottomsheet.BottomSheetDialogFragment

/**
 * Bottom sheet dialog send files
 *
 * @constructor Create empty Bottom sheet dialog send files
 */
class BottomSheetDialogSendFiles: BottomSheetDialogFragment() {
    private var onCompleteListener: OnCompleteListener? = null
    private var mgr: InputMethodManager? = null
    private var _binding: BottomSheetSendFilesBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        _binding = BottomSheetSendFilesBinding.inflate(inflater, container, false)
        return binding.root
    }
