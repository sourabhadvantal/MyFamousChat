...
import com.advantal.myfamouschat.databinding.BottomSheetBlockBinding
...
/**
 * Bottom sheet dialog block
 *
 * @constructor Create empty Bottom sheet dialog block
 */
class BottomSheetDialogBlock: BottomSheetDialogFragment() {
    private var onCompleteListener: OnCompleteListener? = null
    private var mgr: InputMethodManager? = null
    private var _binding: BottomSheetBlockBinding? = null
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?
        ...
        _binding = BottomSheetBlockBinding.inflate(inflater, container, false)
        return binding.root
    }
